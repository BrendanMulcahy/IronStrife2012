...
class SuicideCommand : ConsoleCommand
{
    ...
    {
        Util.MyLocalPlayerObject.GetCharacterStats().ApplyDamage(Util.MyLocalPlayerObject, new Damage(999999, Util.MyLocalPlayerObject,Vector3.zero, DamageType.Pure));
    }
}
