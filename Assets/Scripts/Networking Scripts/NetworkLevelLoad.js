...
{
	GetComponent("Third Person Player(Clone)").GetComponent("CharacterStats").networkPlayer = a_owner;
	GetComponent("Third Person Player(Clone)").GetComponent("CharacterStats").id = a_owner.ToString();
}
